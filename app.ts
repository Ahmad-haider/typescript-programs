...
var num1:number = 4564
var num2:number = 4575
...
else{console.log(`Enter number between 1 and 12 `);
}
...
var determinent:number = b*b -4*a*c
...
var sellingprice:number = 31
var costprice:number = 23
var profit:number = sellingprice - costprice
var loss:number = costprice - sellingprice
...
var Physics:number = 100
var Chemistry:number = 0.5
var Biology:number = 100
var Mathematics:number = 100
var Computer:number = 100

var Total:number = Physics + Chemistry + Biology + Mathematics + Computer

var percentage:number = Total/500 * 100
...
var Basic:number = 23000
var HRA:number = Basic 
var DA:number = Basic
var Gross:number = Basic + DA + HRA 
...
var unit:number = 34
var charges:number = unit
var surcharge:number = 0.2
var Totalcharges:number = charges + surcharge
